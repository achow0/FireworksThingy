...
class Application:
    ...
    def fireworks(self, x, y, branches):
        ...
        self.root.after(random.randrange(100, 2000, 100), self.fireworks, random.randint(200,600), random.randint(200,600), random.randint(5, 15))
...
application.fireworks(random.randint(200,600), random.randint(200,600), random.randint(5, 15))
tk.mainloop()
